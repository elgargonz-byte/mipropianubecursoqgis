...
map.getView().fit([-1060742.840231, 5092774.066708, -623788.125321, 5340963.069926], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Ejercicio sobre complemente QGIS2WEB</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (67 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Visor desarrollado como práctica para usar el complemente "qgisweb"';
            }
